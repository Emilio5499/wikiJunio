...
Route::middleware([SetLocale::class])->group(function () {
    ...
    Route::get('/wiki', [PublicArticleController::class, 'index'])
        ->name('wiki.index');

    Route::get('/wiki/{article}', [PublicArticleController::class, 'show'])
        ->name('wiki.show');

    Route::middleware(['auth'])->group(function () {

        Route::get('/articles/{article}/edit', [PublicArticleController::class, 'edit'])
            ->name('articles.edit');

        Route::put('/articles/{article}', [PublicArticleController::class, 'update'])
    ...
    Route::middleware(['auth', 'permission:manage categories'])
        ->get('/admin/categories', fn () => view('admin.categories'))
        ->name('admin.categories');

    Route::middleware(['auth', 'permission:manage tags'])
        ->get('/admin/tags', fn () => view('admin.tags'))
        ->name('admin.tags');
});
