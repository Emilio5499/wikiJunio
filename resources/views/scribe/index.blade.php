                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-articles--id--pdf">
                                <a href="#endpoints-GETapi-articles--id--pdf">GET api/articles/{id}/pdf</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="posts">
                    <a href="#posts">posts</a>
                                    ...
                                    <ul id="tocify-subheader-posts" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="posts-POSTapi-articles">
                                <a href="#posts-POSTapi-articles">Crear post nuevo</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="posts-GETapi-articles">
                                <a href="#posts-GETapi-articles">Listar todos los posts</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-articles--id--pdf">GET api/articles/{id}/pdf</h2>
...
<span id="example-requests-GETapi-articles--id--pdf">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/articles/architecto/pdf" \
...
<div class="javascript-example">
    ...
    "http://localhost/api/articles/architecto/pdf"
);
...
<span id="example-responses-GETapi-articles--id--pdf">
            <blockquote>
...
<span id="execution-results-GETapi-articles--id--pdf" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-articles--id--pdf"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-articles--id--pdf"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-articles--id--pdf" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-articles--id--pdf">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-articles--id--pdf" data-method="GET"
      data-path="api/articles/{id}/pdf"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-articles--id--pdf', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-articles--id--pdf"
                    onclick="tryItOut('GETapi-articles--id--pdf');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-articles--id--pdf"
                    onclick="cancelTryOut('GETapi-articles--id--pdf');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-articles--id--pdf"
            ...
            <b><code>api/articles/{id}/pdf</code></b>
        </p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-articles--id--pdf"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-articles--id--pdf"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-articles--id--pdf"
               value="architecto"
               data-component="url">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/articles/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/articles/16"
);
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="posts">posts</h1>
                                ...
                                <h2 id="posts-POSTapi-articles">Crear post nuevo</h2>
...
<p>The <code>id</code> of an existing record in the categories table.</p>
                    ...
                    <h2 id="posts-GETapi-articles">Listar todos los posts</h2>
